...
In terms of effectiveness, we believe that manual functional testing was more efficient. Because the inputs and pre conditions were already defined, it make the process of testing different functionalities a bit smoother compared to exploratpry testing.
